...
class TestContextualPrefix:
    def test_chunk_content_has_prefix(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_includes_heading(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_includes_tags(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_truncates_tags_at_five(self, parser: VaultParser, tmp_vault: Path) -> None:
        tags = "[a, b, c, d, e, f, g]"
    ...
    def test_chunk_id_unchanged(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_no_heading_no_section(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_no_tags_no_tags_part(self, parser: VaultParser, tmp_vault: Path) -> None:
    ...
    def test_prefix_on_paragraph_split_chunks(self, parser: VaultParser, tmp_vault: Path) -> None:
