...
def register_handlers(handlers: CommandHandlers) -> None:
    ...
    async def cmd_start(message: Message) -> None:
        await message.answer(
            ...
            "• `/edit <note> <instruction>` → edit a note (prior text preserved)\n"
            "• `/delete <note>` → mark a note superseded (never deletes text)\n"
    ...
    async def cmd_help(message: Message) -> None:
        await message.answer(
            ...
            "confirmation. Never overwrites: the prior body is preserved "
            "under a dated superseded callout.\n"
            "• `/delete <note>` — mark superseded with confirmation. Never "
            "deletes text: writes a dated superseded callout and drops "
            "the note from search instead.\n"
